...
const STATIC_PAGES: PageDef[] = [
  ...
  { slug: "medigap-by-carrier", label: "Medigap by Carrier (Index)", path: "/medicare-supplements/medigap-by-carrier" },
  { slug: "medigap-carrier-accendo-medicare-supplement-plans", label: "Accendo Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/accendo-medicare-supplement-plans" },
  { slug: "medigap-carrier-medico-medigap-plans", label: "Medico Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/medico-medigap-plans" },
  { slug: "medigap-carrier-bankers-fidelity-medigap-plans", label: "Bankers Fidelity Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/bankers-fidelity-medigap-plans" },
  { slug: "medigap-carrier-united-american-medigap-plans", label: "United American Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/united-american-medigap-plans" },
  { slug: "medigap-carrier-united-healthcare-medigap-plans", label: "UnitedHealthcare Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/united-healthcare-medigap-plans" },
  { slug: "medigap-carrier-blue-cross-blue-shield-medigap-plans", label: "Blue Cross Blue Shield Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/blue-cross-blue-shield-medigap-plans" },
  { slug: "medigap-carrier-cigna-medigap-plans", label: "Cigna Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/cigna-medigap-plans" },
  { slug: "medigap-carrier-aetna-medicare-supplement-plans", label: "Aetna Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/aetna-medicare-supplement-plans" },
  { slug: "medigap-carrier-humana-medigap-plans", label: "Humana Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/humana-medigap-plans" },
  { slug: "medigap-carrier-mutual-of-omaha-medigap-plans", label: "Mutual of Omaha Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/mutual-of-omaha-medigap-plans" },
  { slug: "medigap-carrier-gpm-medigap-plans", label: "GPM Life Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/gpm-medigap-plans" },
  { slug: "medigap-carrier-gerber-life-medigap-plans", label: "Gerber Life Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/gerber-life-medigap-plans" },
  { slug: "medigap-carrier-national-general", label: "National General Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/national-general" },
  { slug: "medigap-carrier-manhattan-life-medigap-plans", label: "Manhattan Life Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/manhattan-life-medigap-plans" },
  { slug: "medigap-carrier-oxford-life-medigap-plans", label: "Oxford Life Medigap Plans", path: "/medicare-supplements/medigap-by-carrier/oxford-life-medigap-plans" },
  // Medigap by-state pages
  { slug: "medigap-by-state", label: "Medigap by State (Index)", path: "/medicare-supplements/medigap-by-state" },
  { slug: "medigap-state-massachusetts-medigap-plans", label: "Massachusetts Medigap Plans", path: "/medicare-supplements/medigap-by-state/massachusetts-medigap-plans" },
  { slug: "medigap-state-wisconsin-medigap-plans", label: "Wisconsin Medigap Plans", path: "/medicare-supplements/medigap-by-state/wisconsin-medigap-plans" },
  { slug: "medigap-state-minnesota-medigap-plans", label: "Minnesota Medigap Plans", path: "/medicare-supplements/medigap-by-state/minnesota-medigap-plans" },
  { slug: "medigap-state-florida-medigap-plans", label: "Florida Medigap Plans", path: "/medicare-supplements/medigap-by-state/florida-medigap-plans" },
  { slug: "medigap-state-new-jersey-medigap-plans", label: "New Jersey Medigap Plans", path: "/medicare-supplements/medigap-by-state/new-jersey-medigap-plans" },
  { slug: "medigap-state-texas-medigap-plans", label: "Texas Medigap Plans", path: "/medicare-supplements/medigap-by-state/texas-medigap-plans" },
  { slug: "medigap-state-california-medigap-plans", label: "California Medigap Plans", path: "/medicare-supplements/medigap-by-state/california-medigap-plans" },
  { slug: "medigap-state-connecticut-medigap-plans", label: "Connecticut Medigap Plans", path: "/medicare-supplements/medigap-by-state/connecticut-medigap-plans" },
  { slug: "medigap-state-arizona-medigap-plans", label: "Arizona Medigap Plans", path: "/medicare-supplements/medigap-by-state/arizona-medigap-plans" },
  { slug: "medigap-state-georgia-medigap-plans", label: "Georgia Medigap Plans", path: "/medicare-supplements/medigap-by-state/georgia-medigap-plans" },
  { slug: "medigap-state-pennsylvania-medigap-plans", label: "Pennsylvania Medigap Plans", path: "/medicare-supplements/medigap-by-state/pennsylvania-medigap-plans" },
  { slug: "medigap-state-oklahoma-medigap-plans", label: "Oklahoma Medigap Plans", path: "/medicare-supplements/medigap-by-state/oklahoma-medigap-plans" },
  { slug: "medigap-state-vermont-medigap-plans", label: "Vermont Medigap Plans", path: "/medicare-supplements/medigap-by-state/vermont-medigap-plans" },
  { slug: "medigap-state-new-york-medigap-plans", label: "New York Medigap Plans", path: "/medicare-supplements/medigap-by-state/new-york-medigap-plans" },
  { slug: "medigap-state-louisiana-medigap-plans", label: "Louisiana Medigap Plans", path: "/medicare-supplements/medigap-by-state/louisiana-medigap-plans" },
  { slug: "medigap-state-kentucky-medigap-plans", label: "Kentucky Medigap Plans", path: "/medicare-supplements/medigap-by-state/kentucky-medigap-plans" },
  { slug: "medigap-state-michigan-medigap-plans", label: "Michigan Medigap Plans", path: "/medicare-supplements/medigap-by-state/michigan-medigap-plans" },
  { slug: "medigap-state-mississippi-medigap-plans", label: "Mississippi Medigap Plans", path: "/medicare-supplements/medigap-by-state/mississippi-medigap-plans" },
  { slug: "medigap-state-oregon-medigap-plans", label: "Oregon Medigap Plans", path: "/medicare-supplements/medigap-by-state/oregon-medigap-plans" },
  { slug: "medigap-state-tennessee-medigap-plans", label: "Tennessee Medigap Plans", path: "/medicare-supplements/medigap-by-state/tennessee-medigap-plans" },
  { slug: "medigap-state-ohio-medigap-plans", label: "Ohio Medigap Plans", path: "/medicare-supplements/medigap-by-state/ohio-medigap-plans" },
  { slug: "medigap-state-virginia-medigap-plans", label: "Virginia Medigap Plans", path: "/medicare-supplements/medigap-by-state/virginia-medigap-plans" },
  { slug: "medigap-state-new-mexico-medigap-plans", label: "New Mexico Medigap Plans", path: "/medicare-supplements/medigap-by-state/new-mexico-medigap-plans" },
  // Original Medicare sub-pages
  { slug: "part-a", label: "Medicare Part A", path: "/original-medicare/medicare-parts/medicare-part-a" },
  { slug: "part-b", label: "Medicare Part B", path: "/original-medicare/medicare-parts/medicare-part-b" },
  // Part D sub-pages
  { slug: "part-d-silverscript", label: "Part D: SilverScript", path: "/original-medicare/medicare-parts/medicare-part-d/silverscript" },
  { slug: "part-d-medicare-part-d-plans-2026", label: "Part D Plans 2026", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-plans-2026" },
  { slug: "part-d-medicare-part-d-enrollment-periods", label: "Part D Enrollment Periods", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-enrollment-periods" },
  { slug: "part-d-medicare-part-d-eligibility", label: "Part D Eligibility", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-eligibility" },
  { slug: "part-d-medicare-part-d-coverage-gap", label: "Part D Coverage Gap", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-coverage-gap" },
  { slug: "part-d-medicare-part-d-formulary", label: "Part D Formulary", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-formulary" },
  { slug: "part-d-medicare-part-d-late-enrollment-penalty", label: "Part D Late Enrollment Penalty", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-late-enrollment-penalty" },
  { slug: "part-d-medicare-part-d-deductible", label: "Part D Deductible", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-deductible" },
  { slug: "part-d-medicare-part-d-cost", label: "Part D Costs", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-cost" },
  { slug: "part-d-medicare-part-d-drug-tiers", label: "Part D Drug Tiers", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-drug-tiers" },
  { slug: "part-d-medicare-part-d-prior-authorization", label: "Part D Prior Authorization", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-prior-authorization" },
  { slug: "part-d-medicare-part-d-step-therapy", label: "Part D Step Therapy", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-step-therapy" },
  { slug: "part-d-medicare-part-d-exceptions-and-appeals", label: "Part D Exceptions & Appeals", path: "/original-medicare/medicare-parts/medicare-part-d/medicare-part-d-exceptions-and-appeals" },
  // Caregiver Guide pages
  { slug: "caregiver-guide", label: "Caregiver Guide (Index)", path: "/guide-to-being-a-caregiver" },
  { slug: "caregiver-caregiver-assistance", label: "Caregiver Assistance Programs", path: "/guide-to-being-a-caregiver/caregiver-assistance" },
  { slug: "caregiver-who-qualifies-as-a-caregiver-under-medicare-rules", label: "Who Qualifies as a Caregiver", path: "/guide-to-being-a-caregiver/who-qualifies-as-a-caregiver-under-medicare-rules" },
  { slug: "caregiver-how-to-become-a-caregiver", label: "How to Become a Caregiver", path: "/guide-to-being-a-caregiver/how-to-become-a-caregiver" },
  { slug: "caregiver-what-are-the-4-types-of-caregivers", label: "What Are the 4 Types of Caregivers?", path: "/guide-to-being-a-caregiver/what-are-the-4-types-of-caregivers" },
  { slug: "caregiver-what-is-a-caregiver", label: "What Is a Caregiver?", path: "/guide-to-being-a-caregiver/what-is-a-caregiver" },
  // Medicare Advantage sub-pages
  { slug: "medicare-advantage", label: "Medicare Advantage (Index)", path: "/medicare-part-c" },
  { slug: "medicare-advantage-medicare-advantage-plan-hmo-pos", label: "Medicare Advantage HMO/POS", path: "/medicare-part-c/medicare-advantage-plan-hmo-pos" },
  { slug: "medicare-advantage-medicare-advantage-eligibility", label: "Medicare Advantage Eligibility", path: "/medicare-part-c/medicare-advantage-eligibility" },
  { slug: "medicare-advantage-medicare-advantage-enrollment-periods", label: "Medicare Advantage Enrollment Periods", path: "/medicare-part-c/medicare-advantage-enrollment-periods" },
  { slug: "medicare-advantage-medicare-advantage-plan-snp", label: "Medicare Advantage SNP Plans", path: "/medicare-part-c/medicare-advantage-plan-snp" },
  { slug: "medicare-advantage-medicare-advantage-plan-pffs", label: "Medicare Advantage PFFS Plans", path: "/medicare-part-c/medicare-advantage-plan-pffs" },
  { slug: "medicare-advantage-medicare-advantage-plan-ppo", label: "Medicare Advantage PPO Plans", path: "/medicare-part-c/medicare-advantage-plan-ppo" },
  { slug: "medicare-advantage-medicare-advantage-costs", label: "Medicare Advantage Costs", path: "/medicare-part-c/medicare-advantage-costs" },
  { slug: "medicare-advantage-medicare-advantage-vs-original-medicare", label: "Medicare Advantage vs. Original Medicare", path: "/medicare-part-c/medicare-advantage-vs-original-medicare" },
];
