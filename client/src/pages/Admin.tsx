...
const BLOG_SLUGS = [
  "medicare-2026-premiums-deductibles-out-of-pocket-costs",
  "why-retirees-switching-away-from-medicare-advantage",
  "real-cost-prior-authorization-medicare-advantage",
  "medigap-plan-f-vs-g-over-time",
  ...
  "medicare-supplement-plan-g-the-most-popular-medigap-plan",
